import { stratagems, getRandomStratagem, getKeySymbol } from "../data/stratagems";
    ...
    Alpine.data("stratagemGame", () => ({
        ...
        handleCorrectKey() {
            ...
            if (this.currentIndex >= this.currentStratagem.sequence.length) {
                ...
                this.gameMessage = '<span class="text-terminal-green">✅ SEQUENCE COMPLETED! Excellent work, Helldiver!</span>';
                this.gameStatus = "COMPLETED";

                setTimeout(() => {
                    this.startLoadingSequence(800);
                }, 500);
            } else {
